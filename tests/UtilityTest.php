...
class UtilityTest extends TestCase
{
    ...
    public function it_can_prepare_the_parameters_for_the_request()
    {
        ...
        $this->assertSame('amount=012', Utility::prepareParameters([ 'amount' => '012' ]));
        ...
        $this->assertSame('price=012', Utility::prepareParameters([ 'price' => '012' ]));
        $this->assertSame('price=1200', Utility::prepareParameters([ 'price' => 1200 ]));
        $this->assertSame('price=1299', Utility::prepareParameters([ 'price' => 1299 ]));

        $this->assertSame('amount=12&currency=JPY', Utility::prepareParameters([ 'amount' => 12, 'currency' => 'JPY' ]));
        $this->assertSame('amount=1200&currency=USD', Utility::prepareParameters([ 'amount' => 1200, 'currency' => 'USD' ]));
        $this->assertSame('amount=500&currency=CLP', Utility::prepareParameters([ 'amount' => 500, 'currency' => 'CLP' ]));
        $this->assertSame('amount=50000&currency=SEK', Utility::prepareParameters([ 'amount' => 50000, 'currency' => 'SEK' ]));

        $this->assertSame('price=12&currency=JPY', Utility::prepareParameters([ 'price' => 12, 'currency' => 'JPY' ]));
        $this->assertSame('price=1200&currency=USD', Utility::prepareParameters([ 'price' => 1200, 'currency' => 'USD' ]));
        $this->assertSame('price=500&currency=CLP', Utility::prepareParameters([ 'price' => 500, 'currency' => 'CLP' ]));
        $this->assertSame('price=50000&currency=SEK', Utility::prepareParameters([ 'price' => 50000, 'currency' => 'SEK' ]));
    }
}
